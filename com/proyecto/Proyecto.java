...
public class Proyecto {
	...
	Scanner scanner = new Scanner(System.in);
	    ...
	    opcion = Menu.getUserInt(scanner);
		    ...
		    System.out.print("Seleccione ancho de banda: ");
            
            
		    double banda = Menu.getUserInt(scanner);


			 startTime = System.currentTimeMillis();
			 ejecutarFaseAnalisis( outputDir ,  geometry,numOoo,banda);
			 endTime = System.currentTimeMillis();
			System.out.printf("tiempo ejecucion %d ms\n", endTime-startTime);
	    ...
	    System.out.print("Seleccione ancho de banda: ");
		     ...
		     banda = Menu.getUserInt(scanner);

				     startTime = System.currentTimeMillis();
				     prepararDatos();
				     ejecutarFaseAnalisis( outputDir ,  geometry,numOo,banda);
			 endTime = System.currentTimeMillis();
			System.out.printf("tiempo ejecucion %d ms\n", endTime-startTime);
...
// This method should be inside your main class, Proyecto.java
    ...
    private static void ejecutarFaseAnalisis(String outputDir, DataGeometry geometry, double target, double anchoDeBanda) {
    ...
    ProcesoAgregarRangoOnda miProceso = new ProcesoAgregarRangoOnda(targetWavenumber-anchoDeBanda/2,targetWavenumber+anchoDeBanda/2);
